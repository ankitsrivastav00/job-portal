...
//       {loading ? <Button className="w-full my-4"><Loader2 className='mr-2 h-4 w-4 animate-spin'/>Please Wait</Button>:<Button type="submit" className="w-full mt-4">Post New Job</Button>}
//       {
//         companies.length === 0 && <p className='text-xs text-red-600 font-bold text-center my-3'>Please register a company , before posting a jobs </p>
//       }
//       </form>
//      </div>
//     </div>
...
const PostJob = () => {
  ...
  const submitHandler = async(e) =>{
    ...
    try{
      ...
      console.log("FINAL DATA:", jobData);
